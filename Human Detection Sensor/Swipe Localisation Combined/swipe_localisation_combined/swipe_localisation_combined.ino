...
int timeThreshold = 0;
int iterations = 1000;
signed long diff_13_s = 0;
signed long diff_24_s = 0;
signed long diff_13_f = 0;
signed long diff_24_f = 0;
  ...
  if (movementSensor.available())
  {
    ...
    if(sensorRaw.ir1 < crossingThreshold && sensorRaw.ir2 < crossingThreshold && sensorRaw.ir3 < crossingThreshold && sensorRaw.ir4 < crossingThreshold) { 
      if(crossings.ir1[0] != 0 && crossings.ir2[0] != 0 && crossings.ir3[0] != 0 && crossings.ir4[0] != 0 && crossings.ir1[1] != 0 && crossings.ir2[1] != 0 &&
        ...
        diff_13_s = crossings.ir1[0] - crossings.ir3[0]; // difference between start along 13 axis
        diff_24_s = crossings.ir2[0] - crossings.ir4[0]; // difference between start along 24 axis
        diff_13_f = crossings.ir1[1] - crossings.ir3[1]; // difference between finish along 13 axis
        diff_24_f = crossings.ir2[1] - crossings.ir4[1]; // difference between finish along 24 axis
