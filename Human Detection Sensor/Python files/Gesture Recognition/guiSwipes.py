...
class Grid2D(object):
    ...
    def render(self, screen):
        ...
        pygame.draw.circle(screen, (255, 0, 0), (int(self.user_pos.x), int(self.user_pos.y)), 5)
        ...
        for event in pygame.event.get():
            ...
            if event.type == QUIT:
                ...
                if event.button is 1:
                    # if cycle % 4 == 0:
                    # 	gs.move(1, Vector2(mouse_pos[0] - 100, mouse_pos[1]), Vector2(mouse_pos[0], mouse_pos[1]), 0)
                    # elif cycle % 4 == 1:
                    # 	gs.move(1, Vector2(mouse_pos[0], mouse_pos[1]), Vector2(mouse_pos[0] - 100, mouse_pos[1]), 180)
                    # elif cycle % 4 == 2:
                    # 	gs.move(1, Vector2(mouse_pos[0], mouse_pos[1]), Vector2(mouse_pos[0], mouse_pos[1] - 100), 90)
                    # elif cycle % 4 == 3:
                    # 	gs.move(1, Vector2(mouse_pos[0], mouse_pos[1] - 100), Vector2(mouse_pos[0], mouse_pos[1]), 270)
                    # cycle += 1;
                    #gs.rotate(1)
                    pass
